...
import br.gov.cgu.projetoexemplosb.aplicacao.unidade.GerenciadorDeUnidade;
import br.gov.cgu.projetoexemplosb.aplicacao.unidade.UnidadeNaoPodeSerAtivadaException;
