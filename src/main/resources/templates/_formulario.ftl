...
<#--
 ...
 -->
<#macro campoSelectFormulario label id opcaoPadrao="" opcaoTodos=false opcaoNenhum=false opcoes=[] tipoOpcao="ENUM" valorSelecionado=[] obrigatorio=false disabled=false readonly=false multiplo=false propriedades="">
    <div class="form-group">
        <label for="${id}">${label}</label>
        <#if obrigatorio>
        <div class="input-group">
