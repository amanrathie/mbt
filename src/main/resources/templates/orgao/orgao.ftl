...
<#-- @ftlvariable name="dto" type="br.gov.cgu.projetoexemplosb.negocio.unidade.Orgao" -->
<#assign scriptContent>

<script type="text/javascript" src="<@spring.url "/static/js/orgao/CadastroOrgao.js"/>"></script>

</#assign>

<#assign breadcrumb>
<i class="fa fa-building"></i> Cadastro de Órgão
</#assign>

<@layout.portal script=scriptContent titulo="Cadastro de Órgão" breadcrumb=breadcrumb>
    ...
    <form id="form" method="post">
        ...
        <@bs.panel titulo="Dados do Órgão">
            <fieldset>
                <div class="row">
                    <div class="col-md-12">
            ...
            <a class="btn btn-default btn-labeled" href='<@spring.url "/auth/orgao"/>'><span class="btn-label"><i class="fa fa-arrow-left"></i></span> Voltar</a>
            <#if !disabled>
